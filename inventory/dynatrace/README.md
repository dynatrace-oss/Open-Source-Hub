...
|---|---|---|
| 🟢 **Strategic** | 12 | `dynatrace-operator`, `dynatrace-configuration-as-code`, `dynatrace-otel-collector`, `dynatrace-for-ai`, `helm-charts`, `Dynatrace-OneAgent-Ansible`, `backstage-plugin`, `dynatrace-bootstrapper`, `bosh-oneagent-release`, `swift-mobile-sdk`, `dynatrace-bindplane-otel-collector` |
